...
function (_DragDropController) {
  ...
  _createClass(_default, [{
    ...
    key: "showMessage",
    value: function showMessage(message) {//document.getElementById("messages").innerHTML = message
    }
  }, {
    key: "ajaxOptions",
    ...
    key: "unsuccessful",
    value: function unsuccessful(response, status, error, request) {
...
/******/ });
//# sourceMappingURL=application-0c1f218128f48b9f4370.js.map