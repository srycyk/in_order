...
var map = {
	"./drag_drop_controller.js": "./app/javascript/controllers/drag_drop_controller.js",
...
function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    value: function dragstart(event) {
      var itemId = event.target.getAttribute(this.constructor.dataId);
    ...
    value: function drop(event) {
      var dropppedElement = event.target;
      var draggedElement = this.getDraggedElement(event.dataTransfer);
      var placement = this.dropOffAt(draggedElement, dropppedElement);
      var dragId = draggedElement.getAttribute(this.constructor.dataId);
      var dropId = dropppedElement.getAttribute(this.constructor.dataId);

      if (placement) {
        var at = placement == 'before' ? 'beforebegin' : 'afterend';
    ...
    value: function getDraggedElement(dataStore) {
      var itemId = dataStore.getData(this.constructor.draggedIdKeyName);
      var selector = "[".concat(this.constructor.dataId, "='").concat(itemId, "']");
      return this.element.querySelector(selector);
    }
  }, {
    key: "dropOffAt",
    value: function dropOffAt(draggedItem, dropTarget) {
      var positionComparison = dropTarget.compareDocumentPosition(draggedItem);
      if (positionComparison & 4) return 'before';else if (positionComparison & 2) return 'after';else return null;
    } // To be overridden

  }, {
    key: "update",
    value: function update(dragId, dropId, placement) {
...
_default.draggedIdKeyName = "in-order/draggged-id";
_default.dataId = "data-element-id";
...
/* harmony import */ var _drag_drop_controller_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./drag_drop_controller.js */ "./app/javascript/controllers/drag_drop_controller.js");
...
var _default =
/*#__PURE__*/
function (_DragDropController) {
  _inherits(_default, _DragDropController);
  ...
  _createClass(_default, [{
    ...
    value: function update() {
      rails_ujs__WEBPACK_IMPORTED_MODULE_0___default.a.ajax(this.ajaxOptions.apply(this, _toConsumableArray(this.requestArgs.apply(this, arguments))));
    }
  }, {
    key: "requestArgs",
    value: function requestArgs(dragId, dropId, placement) {
      var url = "/in_order/elements/".concat(dragId);
      var fields = {
        marker_id: dropId,
        adjacency: placement
      };
      var params = this.params(fields, 'element');
    ...
    key: "ajaxOptions",
    value: function ajaxOptions(url, params) {
    ...
    key: "params",
    value: function params(_params, name) {
      var _this = this;

      return Object.entries(_params).map(function (args) {
        return _this.param.apply(_this, _toConsumableArray(args).concat([name]));
      }).join('&');
    }
  }, {
    key: "param",
    value: function param(name, value) {
      ...
      var _ref = prefix == '' ? ['', ''] : ['[', ']'],
          ...
          leftBracket = _ref2[0],
          rightBracket = _ref2[1];

      return "".concat(prefix).concat(leftBracket).concat(name).concat(rightBracket, "=").concat(value);
    }
  }, {
    key: "handleSuccess",
    value: function handleSuccess(request) {
      ...
      return function (data) {
        return _this2.successful(data, request);
      };
    }
  }, {
    key: "successful",
    value: function successful(data, request) {
    ...
    value: function handleError(request) {
      ...
      return function () {
        ...
        return _this3.unsuccessful.apply(_this3, args.concat([request]));
      };
    }
  }, {
    key: "usuccessful",
    value: function usuccessful(response, status, error, request) {
  ...
  return _default;
}(_drag_drop_controller_js__WEBPACK_IMPORTED_MODULE_1__["default"]);
...
/******/ });
//# sourceMappingURL=application-aace9a721c58bb3467dc.js.map